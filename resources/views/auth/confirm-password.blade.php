...
<head>
    ...
    <title>Confirmation - RoomMaster</title>
...
<body class="bg-slate-50 font-sans text-slate-900 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-xl shadow-slate-200/60 border border-slate-100 p-8 md:p-10">
        <div class="text-center mb-10">
            ...
            <h1 class="text-2xl font-black tracking-tight text-slate-900 uppercase">Zone Sécurisée</h1>
            <p class="text-slate-500 text-sm mt-2">Confirmez votre mot de passe avant de continuer.</p>
        </div>
